...
const COAddress = () => {
  ...
  const userInfo = useSelector(
    (state) => state.persistedReducer?.auth?.user[0]
  );
        ...
        <div className="w-full">
          <div className="w-[94%] h-[70vh] mx-10">
            ...
            <div className="grid grid-cols-2 px-20">
                  ...
                  <div
                    className={`${
                      selectedValue === userInfo
                        ? `bg-gray-300 ring ring-sky-600`
                        : `bg-gray-300`
                    } w-full px-4 py-2 flex justify-between cursor-pointer`}
              ...
              <form
                className="w-[94%] h-[90%] mx-10 my-8 bg-gray-100 flex flex-col justify-center px-20"
