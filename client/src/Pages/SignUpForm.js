...
const SignUpForm = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center'>
        <ToastContainer/>
        <h1 className='text-3xl font-bold pt-8 text-transparent bg-clip-text bg-gradient-to-br from-pink-400 to-orange-600'>Join with us</h1>     
    <form className='grid grid-cols-1 md:grid-cols-2 gap-4 rows-2 my-20 w-max h-max bg-white shadow-md rounded-lg' onSubmit={SignUp}>
        <div className=' pt-8 pl-5 block'>
            <label htmlFor='username' className=' text-neutral-600'>User Name: </label>
            <input id='username' className='px-2 block w-[300px] mr-5 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:outline-none focus:ring-inset focus:ring-0 sm:text-sm sm:leading-6'
        ...
        <div className='pt-8 pl-5 block'>
            ...
            <input className='px-2 block w-[300px] mr-5 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:outline-none focus:ring-inset focus:ring-0 sm:text-sm sm:leading-6'
        ...
        <div className='pt-8 pl-5 block'>
            ...
            <input className='px-2 block w-[300px] mr-5 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:outline-none  focus:ring-inset focus:ring-0 sm:text-sm sm:leading-6'
                value={phone} onChange={(e) => setPhone(e.target.value)} type='number'
            />
        </div>
        
        <div className=' col-span-full text-center mt-6'>
            <button type='submit' className=' bg-orange-500 text-white py-1 rounded-md w-[300px]'>Sign up</button>
        </div>
